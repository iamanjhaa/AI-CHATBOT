...
def classify_severity(problem: str) -> SeverityLevel | None:
    text = problem.lower()
...
def build_mock_response(problem: str) -> ChatResponse | None:
    """Return only an existing contextual answer; unmatched text stays unknown."""
    return build_contextual_fallback_response(problem)
